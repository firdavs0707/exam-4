...
const div = $('.js-div');
let btnPer = $('.js-btn-pervious')
let btnNext = $('.js-btn-next')
...
searchForm.addEventListener("submit", (evt) => {
  ...
  function myGreeting() {
    btnNext.classList.add('send-btn','border-0', 'py-3', 'shadow', 'rounded-4', 'px-5', 'bg-white', 'ms-3')
    btnPer.classList.add('send-btn','border-0', 'py-3', 'shadow', 'rounded-4', 'px-5', 'bg-white', 'ms-3')
...
const showMovie = async title => {
  try {
    let response = await fetch (`http://www.omdbapi.com/?apikey=83a076fe&s=${title}&page=${mainPage}`)
    .finally(spinnerAdd);
